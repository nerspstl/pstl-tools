...
def wrapper_cylinderical_function(voltage, V_s, KT_e, area, n0, m_i, r_p, lambda_D):
    return cylinderical_function(voltage, area, n0, V_s, m_i, KT_e, r_p, lambda_D)


def wrapper_spherical_function(voltage, V_s, KT_e, area, n0, m_i, r_p, lambda_D):
    return spherical_function(voltage, area, n0, V_s, m_i, KT_e, r_p, lambda_D)


def wrapper_planar_function(voltage, V_s, KT_e, area, n0, m_i, r_p, lambda_D):
